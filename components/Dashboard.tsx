        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-black text-black transform -rotate-2">
                  FEED INVENTORY
                </h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <TabsList className="grid w-full grid-cols-2 lg:w-96 bg-white border-4 border-black shadow-[4px_4px_0px_0px_#000000]">
            <TabsTrigger
              value="dashboard"
              className="flex items-center space-x-2 font-black text-black data-[state=active]:bg-green-400"
            >
                          ...
                          <div className="space-y-1 text-sm text-black font-bold">
                            ...
                            {outOfStockInCategory > 0 && (
                              <p className="text-red-600 font-black">
                                OUT OF STOCK: {outOfStockInCategory}
                              </p>
                            )}
                          </div>
                        </div>
            ...
            <Card className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_#000000]">
              ...
              <CardContent className="p-6">
                    ...
                    return (
                      ...
                      >
                        <CardHeader
                          className={`pb-3 ${
                            isOutOfStock
                              ? "bg-red-800 border-b-4 border-red-500"
                              : `${categoryColor} border-b-4 border-black`
                          }`}
                        >
                          <div className="flex items-start justify-between">
                            <CardTitle
                              className={`text-lg font-black ${
                                isOutOfStock ? "text-white" : "text-black"
                              }`}
                            >
                              {item.name}
                            </CardTitle>
                            <Badge
                              className={`${
                                isOutOfStock
                                  ...
                                  : `${categoryColor} border-2 border-black`
                ...
                {filteredItems.length === 0 && (
                  <div className="text-center py-8 text-black font-black text-xl">
                    NO ITEMS FOUND
                  </div>
                )}
              </CardContent>
