  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-yellow-300">
      <Card className="w-full max-w-md border-4 border-black bg-white shadow-[8px_8px_0px_0px_#000000] transform hover:translate-x-1 hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_#000000] transition-all">
        <CardHeader className="text-center space-y-4 bg-pink-400 border-b-4 border-black">
        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="username" className="text-black font-bold text-lg">USERNAME</Label>
              <Input
                id="username"
                type="text"
          ...
          <div className="mt-6 p-4 bg-cyan-200 border-4 border-black transform -rotate-1">
            <p className="text-black font-black text-sm">DEMO CREDENTIALS:</p>
            <p className="text-black font-bold text-sm">USERNAME: admin</p>
            <p className="text-black font-bold text-sm">PASSWORD: password</p>
          </div>
        </CardContent>
      </Card>
    </div>
