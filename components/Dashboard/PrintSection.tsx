          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setPrintForm({ ...printForm, dateType: value })
                }
              >
            ...
            {printForm.dateType === "specific" && (
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setPrintForm({ ...printForm, specificDate: e.target.value })
                  }
              ...
              <>
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setPrintForm({ ...printForm, month: value })
                    }
                  >
                    <SelectTrigger className="border-4 border-black font-bold shadow-[4px_4px_0px_0px_#000000]">
                    ...
                    <SelectContent className="border-4 border-black">
                      {Array.from({ length: 12 }, (_, i) => {
                        ...
                        const disabled =
                          !!printForm.year &&
                          parseInt(printForm.year) === currentYear &&
                          month > currentMonth;
                        return (
                          <SelectItem
                            key={month}
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setPrintForm({ ...printForm, year: value })
                    }
                  >
                    <SelectTrigger className="border-4 border-black font-bold shadow-[4px_4px_0px_0px_#000000]">
        ...
        <Card className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_#000000]">
          <CardHeader className="bg-red-400 border-b-4 border-black">
            ...
            <CardDescription className="text-black font-bold">
              ...
              {items.filter((item) => item.stock === 0).length} items)
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            <Button
