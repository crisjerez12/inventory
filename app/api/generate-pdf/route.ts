...
export async function POST(request: NextRequest) {
  try {
    ...
    doc.text('Microbial Technology Solutions', 20, 28);
    
    doc.setFontSize(10);
    doc.setTextColor(134, 204, 22); // Green accent color
    doc.text('INVENTORY MANAGEMENT SYSTEM', 20, 35);
    ...
    doc.text('Generated by Microtek Inventory Management System', 20, finalY + 22);
    doc.text(`Total Records: ${tableData.length}`, 20, finalY + 28);
    doc.text('© Microtek - Microbial Technology Solutions', 120, finalY + 28);
